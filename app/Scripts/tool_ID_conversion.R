...
get_all_ids <- function(chosen_organism, from_to) {
  ...
  #if(!chosen_dataset %in% listDatasets(mart = useMart('ENSEMBL_MART_ENSEMBL'))) {stop(paste0('There is no ', chosen_dataset, ' data publicly available for ', chosen_organism, '.'))}
